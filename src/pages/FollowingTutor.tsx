...
import NavBar from "../components/NavBarTutor";
...
const FollowingTutors: React.FC = () => {
        ...
        <table className="scheduletable">
          ...
          <tbody>
            {followingTutors.length > 0 ? (
              ...
              <tr>
                <td colSpan={3}>You're not following any tutors yet.</td>
              </tr>
            )}
          </tbody>
        </table>
...
export default FollowingTutors;
